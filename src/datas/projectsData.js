...
export const projects = [
  {
    ...
    description:
      "Une boutique en ligne complète avec gestion de produits, panier et paiement sécurisé.",
  ...
  },
  {
    ...
    description:
      "Une app web de productivité avec drag & drop, collaboration temps réel et statistiques.",
  ...
  },
  {
    ...
    description:
      "Un site responsive avec menu interactif, réservation en ligne et galerie photos.",
